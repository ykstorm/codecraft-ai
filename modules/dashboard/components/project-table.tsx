...
interface ProjectTableProps {
  ...
  onDuplicateProject?: (id: string) => Promise<{ id: string; title: string; template: string; createdAt: Date; updatedAt: Date; userId: string; description: string | null; } | undefined>;
